...
| `F0005` | `T0005` | `Model` | Improve T0005 holdout racket recall before app integration; current candidate beats old app prediction on `audio_session_2026-05-29_002` accuracy but only reaches 0.604 racket recall. | `High` | `Codex` | `Open` |
