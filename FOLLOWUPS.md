...
|---|---|---|---|
| `F0014` | `T0036` | T0034-T0036 resumed performance work after T0033 parity: added review-start timing, deferred whole-video pose until audio markers are ready, and removed repeated candidate timestamp sorting in `spel_retro_audio` without changing output. Cache remains out of scope. | `2026-06-04` |
...
| `F0015` | `T0031` | T0031 exported, built, and installed the T0030 `spel_retro_audio` model on Motorola with racket/table thresholds `0.0/0.0`; Love can now retest the same clip before another training loop. | `2026-06-04` |
